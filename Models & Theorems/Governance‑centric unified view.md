...
flowchart TD
    ...
    B --> B1[Declare join preservation intent<br/>(SFS‑24)]
    B --> B2[Choose join type and sides]
    B --> B3[Identify preserved vs NULL‑producing sides]

    C --> C1[Place filters in ON vs WHERE<br/>(JFS‑24)]
    C --> C2[Classify filters<br/>(NULL‑sensitive vs NULL‑neutral)]
    ...
    D --> D4[Feed back into training & standards]
